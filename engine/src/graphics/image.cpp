...
auto Image::GetExtent() const -> VkExtent2D { return m_extent; }

auto Image::GetFormat() const -> VkFormat { return m_format; }

auto Image::GetLayout() const -> VkImageLayout { return m_layout; }

auto Image::GetUsageFlags() const -> VkImageUsageFlags { return m_usageFlags; }

auto Image::GetAccessFlags() const -> VkAccessFlags2 { return m_accessFlags; }

auto Image::GetStageFlags() const -> VkPipelineStageFlags2 { return m_stageFlags; }

auto Image::Get() const -> VkImage { return m_image; }

auto Image::GetView() const -> VkImageView { return m_imageView; }

auto Image::GetDescriptorInfo() const -> const VkDescriptorImageInfo & { return m_descriptorInfo; }
