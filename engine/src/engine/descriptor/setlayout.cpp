...
namespace muon::engine {
    ...
    DescriptorSetLayout::DescriptorSetLayout(Device &device, const std::unordered_map<uint32_t, vk::DescriptorSetLayoutBinding> &bindings) : device(device), bindings(bindings) {
